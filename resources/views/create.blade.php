                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="icons">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link"
                                        href="{{ route('contacts.index') }}">Контакты</a></li>
                            </ul>
                        </div>
                    </li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="source" name="source" required>
                                        @foreach (['письма','интернет (звонок)','посоветовали','наш
                                        клиент','SMS','стенды','интернет
                                        (заявки)','печать','белянин','интернет (акция)','оператор
                                        кц','интернет (звонок) акция','яндекс услуги'] as $option)
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="addressSettlement" class="form-control address-dropdown"
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="addressPlanningStructure"
                                        ...
                                        name="addressPlanningStructure" data-address-level="7"></select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="addressApartment" class="form-control address-dropdown"
                                ...
                                <button type="button" class="btn btn-danger" id="clearFieldsButton">Очистить
                                    поля</button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            @php
                                            $index = ($applicationsWithDetails->currentPage() - 1) *
                                            $applicationsWithDetails->perPage();
                                            @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('operatorapplication.show', ['id' => $application->application_id]) }}"
